...
const Recharge = () => {
    ...
    const handleSelectPayment = async (method) => {
        ...
        try {
            ...
            // ✅ 🔥 DIRECT INSPAY (MAIN FIX)
            else if (method === 'inspay') {

                const { data } = await api.post('/recharge', {
                    operator,
                    rechargeNumber,
                    mobile: rechargeNumber,   // 🔥 VERY IMPORTANT
                    amount: Number(amount),
                    type
                });
                ...
                if (data.success) {
                    triggerSuccessAlert('Recharge Successful!', amount);
                    toast.success("Recharge successful via Inspay!", { id: toastId });
                    ...
                    toast.error(data.message || "Inspay recharge failed", { id: toastId });
                }
            }
            ...
            // ✅ RAZORPAY PAYMENT
                ...
                const options = {
                    ...
                    prefill: {
                        ...
                        contact: (rechargeNumber || "").toString().slice(-10)
                    },
